...
export default function PopupMixin(getModal: (props: any, visible: any, args: Args) => JSX.Element, platformProps: {
    ...
    new (props: Readonly<PopupPickerProps>): {
        ...
        onOk: () => void;
        getContent: () => string | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)> | React.FunctionComponentElement<{
            [x: string]: any;
            ref: (picker: any) => void;
        }> | undefined;
        onDismiss: () => void;
