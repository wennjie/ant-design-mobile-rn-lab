...
var PopupDatePicker = function (_React$Component) {
    ...
    (0, _createClass3['default'])(PopupDatePicker, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_Popup2['default'], (0, _extends3['default'])({ picker: this.props.datePicker, value: this.props.date }, this.props, { onOk: this.onOk, ref: function ref(e) {
                    _this2.ref = e;
                } }));
        }
    }]);
